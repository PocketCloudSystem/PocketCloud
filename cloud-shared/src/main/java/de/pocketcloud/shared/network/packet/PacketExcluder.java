package de.pocketcloud.shared.network.packet;
...
public final class PacketExcluder {
    ...
    public void applyTo(PacketExcluder excluder) {
        excluder.predicate = predicate;
    }
    ...
    public PacketExcluder verificationStatus(de.pocketcloud.api.server.VerificationStatus verificationStatus) {
