...
final class CloudLogger {
    ...
    public static function get(): ILogger {
        if (Thread::getCurrentThread() !== null) {
            if (self::$instance === null) throw new NoLoggerAvailableException("No logger available for this thread");
            if (self::$instance instanceof ThreadLogger) return self::$instance;
            else throw new NoLoggerAvailableException("Set logger for this thread is not an instance of ThreadLogger");
        } else if (self::$instance instanceof ThreadLogger) {
            throw new NoLoggerAvailableException("Set logger for this thread is an instance of ThreadLogger, but you can't use the ThreadLogger outside a thread");
        }
    ...
    public static function tmp(?string $cloudLogPath = null, bool $debugMode = false, bool $saveLogs = false): ILogger {
        if (Thread::getCurrentThread() !== null) throw new NoLoggerAvailableException("You cannot create a temporary logger inside a thread");
