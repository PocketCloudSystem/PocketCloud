...
class CloudPluginManager implements Tickable, Reloadable {
    ...
    public function registerLoader(CloudPluginLoader $loader) {
        $this->loaders[] = $loader;
    }
    ...
    public function enablePlugin(CloudPlugin $plugin) {
    ...
    public function disablePlugin(CloudPlugin $plugin) {
